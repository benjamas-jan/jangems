...
export const days: Day[] = [
  {
    ...
    advice: 'ทับทิมเสริมพลังภาวะผู้นำและลดความหุนหัน นิยมใส่เป็นแหวนนิ้วชี้หรือแหวนเรือนกลาง',
  },
  {
    id: 'mon', th: 'จันทร์', porn: 'เศตาภรณ์', color: 'เหลือง', hex: '#E8C547',
    gems: ['บุษราคัม', 'ซิทริน', 'อำพัน'],
    ...
    advice: 'บุษราคัม/ซิทรินเสริมความสงบและความมั่นใจในตัวเอง ใส่เป็นต่างหู หรือจี้ใกล้หัวใจ',
  },
  {
    id: 'tue', th: 'อังคาร', porn: 'ตามภาภรณ์', color: 'ชมพู', hex: '#E8A1B8',
    gems: ['แซพไฟร์สีชมพู', 'โรดอนไนท์', 'ไข่มุกสีชมพู'],
  ...
  },
  {
    ...
    advice: 'มรกต/หยกเสริมสติปัญญาและความตั้งมั่น เหมาะใส่เป็นแหวนนิ้วก้อยหรือสร้อยข้อมือ — สำหรับผู้เกิดวันพุธหลัง 18:00 น. (ราหู) นิยมพลอยสีเทา/ดำ เช่น ไพลินสีดำ สตาร์แบล็คแซพไฟร์',
  },
  {
    id: 'thu', th: 'พฤหัสบดี', porn: 'ปิตาภรณ์', color: 'ส้ม', hex: '#E08A47',
    gems: ['โอปอลไฟ', 'ปะการัง', 'สเปสซาร์ไทท์'],
    ...
    advice: 'โอปอลไฟ/ปะการังเสริมบารมีและการตัดสินใจที่หนักแน่น ใส่เป็นแหวนนิ้วชี้',
  },
  {
    id: 'fri', th: 'ศุกร์', porn: 'ปภัสราภรณ์', color: 'ฟ้า', hex: '#6B9DC4',
    gems: ['ไพลิน', 'โทพาซสีฟ้า', 'เทอร์ควอยซ์'],
    ...
    advice: 'ไพลิน/โทพาซสีฟ้าเสริมเสน่ห์และการสื่อสารทางใจ ใส่เป็นต่างหูหรือจี้',
  },
  {
    id: 'sat', th: 'เสาร์', porn: 'กัณหาภรณ์', color: 'ม่วง/ดำ', hex: '#7A5C9E',
    gems: ['อเมทิสต์', 'แซพไฟร์สีม่วง', 'นิลดำ'],
    ...
    advice: 'อเมทิสต์/นิลดำช่วยปรับสมดุลจิตใจ ลดความเครียดสะสม ใส่เป็นแหวนหรือสร้อย',
  },
];
