...
export const navaratna: NavaratnaGem[] = [
  ...
  {
    id: 'zircon', th: 'เพทาย', en: 'Red Zircon (Hyacinth)',
    planet: 'อังคาร', hex: '#C8533C',
    domain: 'พลังกาย · ความกล้า',
    reading: 'พลอยของพระอังคารตามตำราไทยคลาสสิก — เพทายสีแดง (Hyacinth Zircon) เพิ่มพลังกาย สุขภาพ และความกล้าหาญ (บางตำราอินเดีย-ไทยใช้ปะการังสีแดงแทน)',
  ...
  {
    id: 'garnet', th: 'โกเมนน้ำตาล', en: 'Hessonite',
    planet: 'ราหู', hex: '#B25F2E',
    domain: 'ปกป้องภัย',
    reading: 'พลอยของพระราหู โกเมนสายน้ำตาล/น้ำผึ้ง (Hessonite) — ต่างจากโกเมนสีแดงที่คุ้นกัน ปกป้องจากพลังลบ คุณไสย และอุบัติเหตุที่ไม่คาดคิด',
